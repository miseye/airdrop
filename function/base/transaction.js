...
//------------------------------ api ----------------------------
function blockTransaction(t,hashIdCall,success,error, nonceadd = 0){
    ...
    web3.eth.getGasPrice().then(function(p) {
        ...
        web3.eth.getTransactionCount(fromAddress,
            function(err, r) {
                t.nonce = web3.utils.toHex(r+nonceadd);
                t.from = fromAddress;
...
function startBlockTransaction(t,getHashIdCall,successCall,errorCall,nonceadd) {
